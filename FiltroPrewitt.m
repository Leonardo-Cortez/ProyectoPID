...
%{
    ...
    fspecial('prewitt') crea una matriz que representa el núcleo del filtro 
    de Prewitt. Este núcleo se utiliza para resaltar los bordes en la imagen.
    imfilter es la función entre la imagen en escala de grises y el filtro de Prewitt.
%}
